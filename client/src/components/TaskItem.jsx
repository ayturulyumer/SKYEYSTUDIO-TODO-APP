    ...
    return (
      ...
      <div className="flex items-start">
        <button
          ...
          className={`mt-4 flex-shrink-0 w-5 h-5 rounded-full border flex items-center justify-center transition-colors duration-200 cursor-pointer ${
        ...
        <button
          ...
          className="ml-2 p-4 text-red-500  hover:bg-red-100 dark:hover:bg-black/50 rounded transition-colors duration-200 cursor-pointer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
